...
class Entity : public Listener
	...
	public:
		...
		//hzm gameupdate - new floats for the bubbles (for drowning players)
		float				bubbleSplashMax;
		float				bubbleNextThink;
		float				bubbleMaxLife;
		float				bubbleNextSpeedIncrease;
		float				bubbleTotalSpeedIncrease;
		//end of hzm
