...
//moved includes here from mp_manager.cpp [b607]
...
//hzm gameupdate chrissstrahl - i am so sick and tired of overcomplicating it, i need access, give me!
   public:
...
//hzm eof
   private:
	...
	public:
		...
		float							voteTime( void );//hzm gamefix chrissstrahl - used to show vote midvote joined players
		str								getVoteString( void );//hzm gamefix chrissstrahl - used to show vote midvote joined players
		void							updateVotes( Player * player, bool bLeaving );//hzm gamefix chrissstrahl - used to show vote midvote joined players
