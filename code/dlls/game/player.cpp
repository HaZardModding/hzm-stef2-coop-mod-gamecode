...
CLASS_DECLARATION( Sentient , Player , "player" )
{
	...
	{ &EV_Player_checkMenu,						&Player::upgPlayerCheckMenu },
...
//================================================================
// IF YOU ARE LOOKING FOR EVENT RELATED CODE GO LOOK IN:
// 
// COOP CODE	in coopPlayer.cpp
// GAMEUPGRADES	in upgPlayer.cpp
//================================================================
...
Player::~Player()
{
	...
	{
		//[GAMEUPGRADE] chrissstrahl - update vote if a player is leaving
...
Vector Player::upgPlayerGetBackpackAttachAngles( void )
{
...
Vector Player::upgPlayerGetFlagAttachOffset( void )
{
