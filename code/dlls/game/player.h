...
class Player : public Sentient
	...
	public:
		...
		void				upgPlayerCheckAnyButton(Event* ev);
		void				upgPlayerCheckMenu(Event* ev);
		...
		void				upgPlayerCheckLeanRight(Event* ev);
		void				upgPlayerCheckLeanLeft(Event* ev);
		void				upgPlayerCheckDropRune(Event* ev);
		void				upgPlayerCheckRun(Event* ev);
		void				upgPlayerCheckReload(Event* ev);
		void				upgPlayerCheckCrouch(Event* ev);
		void				upgPlayerCheckJump(Event* ev);
		void				upgPlayerCheckUsePressing(Event* ev);
		...
		str					upgPlayerGetPowerupModel(void);
		...
		bool				upgPlayerHasLanguageGerman();
...
//		Vector				GetViewEndPoint( void );
		...
		Vector				upgPlayerGetFlagAttachOffset( void );
