...
char *COM_ParseExt( char **data_p, qboolean allowLineBreaks )
{
	...
	//[b60022] chrissstrahl - Added: Umlauts to the list of valid chars
...
void Info_RemoveKey (char *s, const char *key)
{
	...
	while (1)
	{
		...
		*o = 0;
		...
		if (!strcmp (key, pkey) )
		{
			memmove(start, s, strlen(s) + 1);	// remove this part //[b607] daggolin - fix source/destination overlap
			return;
		}
...
void ParseMapName( const char *fullName, char *mapName, char *spawnposName, char *movieName )
{
	...
	if ( movieNamePtr )
		...
		tempMovieName[ 0 ] = '\0'; //[b607] chrissstrahl - fixed bad code slash direction - thanks to daggolin
	...
	{
		tempSpawnposName[ 0 ] = '\0'; //[b607] chrissstrahl - fixed bad code slash direction - thanks to daggolin
	}
