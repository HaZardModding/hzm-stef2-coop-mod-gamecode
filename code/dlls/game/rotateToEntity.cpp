...
RotateToEntity::RotateToEntity()
{
	...
	//[b607] chrissstrahl - fix uninizialised var that caused the crash in: void MovementSubsystem::setTurnSpeed( float turnSpeed )
	...
	if ( !_ent )
		...
		if ( _entityType == "enemy" )
			...
			if ( g_gametype->integer != GT_SINGLE_PLAYER )
				player = ( Entity * )coop_returnPlayerClosestTo( ( Entity * )this );
			else
