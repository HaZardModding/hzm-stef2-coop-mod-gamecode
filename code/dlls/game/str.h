...
inline void str::append
   ...
   //hzm gamefix chrissstrahl - this has to do something with singleplayer and cutscenes
	//(assert( text );
...
inline char& str::operator[]
   ...
   //hzm chrissstrahl - dissabled cuz i was not able to find wher ethe issue was originating from
   //and I am so sick and tired and can no loger see this fucking shitt assert anylonger
...
inline str& str::operator=
   ...
   //hzm gamefix - this was triggred when certain actors (coop_bugs p3.tik) where vaporised
	//assert( text );
